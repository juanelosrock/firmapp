...
/**
 * This is the model class for table "relclientegrado".
 *
 * The followings are the available columns in table 'relclientegrado':
 * @property integer $id
 ...
 */
class Relclientegrado extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('cliente, colegio, grado', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, cliente, colegio, grado', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Relclientegrado the static model class
	 */
